...
//	struct qnote constant_3_73555 = {30602 , -13};
	...
	slew_rate_qnote.mantissa = ((Uint32)(vcmd.mantissa << (1))) / ((Uint32)ton.mantissa);
...
void configure_fault_levels(void)
{
	...
	struct qnote adc12_temp_scaler = {(4857), (-9)}; 
    struct qnote adc12_iout_scaler = {(19965), (-10)};

	pmbus_dcdc_config_translated[0].vout_uv_fault_limit = qnote_linear16_multiply_fit(adc12_vout_scaler, pmbus_dcdc_config[0].vout_uv_fault_limit, -(9), (0x00FFF));
	pmbus_dcdc_config_translated[0].iout_oc_fault_limit = qnote_linear11_multiply_fit(adc12_iout_scaler, pmbus_dcdc_config[0].iout_oc_fault_limit, (0x00FFF));
	pmbus_dcdc_config_translated[0].temp_ot_fault_limit = 2720 + qnote_linear11_multiply_fit(adc12_temp_scaler, (pmbus_dcdc_config[0].temp_ot_fault_limit - 23), (0x00FFF));
	pmbus_dcdc_config_translated[0].vin_ov_fault_limit  = qnote_linear11_multiply_fit(adc12_vin_scaler, pmbus_dcdc_config[0].vin_ov_fault_limit, (0x00FFF));
	pmbus_dcdc_config_translated[0].vin_uv_fault_limit  = qnote_linear11_multiply_fit(adc12_vin_scaler, pmbus_dcdc_config[0].vin_uv_fault_limit, (0x00FFF));
}
...
void configure_warning_levels(void)
{
	struct qnote adc12_vout_scaler = {(19065), (-7)};
	struct qnote adc12_iout_scaler = {(19965), (-10)};  
	struct qnote adc12_iin_scaler  = {(32716),  (-6)};  
	struct qnote adc12_vin_scaler  = {(25469),  (-9)}; 
	struct qnote adc12_temp_scaler = {(4857), (-9)};
	pmbus_dcdc_config_translated[0].vout_ov_warn_limit = qnote_linear16_multiply_fit(adc12_vout_scaler, pmbus_dcdc_config[0].vout_ov_warn_limit, -(9), (0x00FFF));
	pmbus_dcdc_config_translated[0].vout_uv_warn_limit = qnote_linear16_multiply_fit(adc12_vout_scaler, pmbus_dcdc_config[0].vout_uv_warn_limit, -(9), (0x00FFF));
	pmbus_dcdc_config_translated[0].iout_oc_warn_limit = qnote_linear11_multiply_fit(adc12_iout_scaler, pmbus_dcdc_config[0].iout_oc_warn_limit, (0x00FFF));
	pmbus_dcdc_config_translated[0].iin_oc_warn_limit  = qnote_linear11_multiply_fit(adc12_iin_scaler, pmbus_dcdc_config[0].iin_oc_warn_limit, (0x00FFF));
	pmbus_dcdc_config_translated[0].temp_ot_warn_limit =  qnote_linear11_multiply_fit(adc12_temp_scaler, pmbus_dcdc_config[0].temp_ot_warn_limit, (0x00FFF));
	pmbus_dcdc_config_translated[0].vin_ov_warn_limit  = qnote_linear11_multiply_fit(adc12_vin_scaler, pmbus_dcdc_config[0].vin_ov_warn_limit, (0x00FFF));
...
{
	Uint16 uvp_limit;
	struct qnote vdac_scaler = {(289), -(6)};
	uvp_limit = qnote_linear16_multiply_fit(vdac_scaler, pmbus_dcdc_config[0].vout_uv_fault_limit, -(9), (0x0007F));
...
void configure_ovp(void)
{
	...
	ovp_limit = qnote_linear16_multiply_fit(constant_4_65455 ,
		pmbus_dcdc_config[0].vout_ov_fault_limit, -(9),
		(0x0007F));
