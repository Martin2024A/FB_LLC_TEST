...
//	(adc_values.io_sense < fiq_data.burst_mode_i_turn_on))
 	...
 	if ((fiq_data.fault_status_raw & (1 << 13))  && (fiq_data.vloop_filter < 2500000)) //2400000 is PWM and resonant threshold

	{

 		Filter0Regs.FILTERCTRL.bit.KI_STALL = 1;
 		// Puts a 0 on the DPWM 0 and DPWM 1 pins.
		MiscAnalogRegs.GLBIOEN.all |=  ((1 << (0)) | (1 << (1)) |	(1 << (2)) | (1 << (3)));
	...
	else if (fiq_data.fault_status_raw & (1 << 14))
	{
	...
	fiq_data.fault_status &= ~((1 << 13) | (1 << 14) | (1 << 15));
}
