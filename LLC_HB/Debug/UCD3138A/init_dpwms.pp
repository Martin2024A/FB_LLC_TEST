...
void init_dpwm0(void)
{
  ...
  Dpwm0Regs.DPWMCTRL0.bit.PWM_A_INTRA_MUX = (6);    //DPWM1C
  Dpwm0Regs.DPWMCTRL0.bit.PWM_B_INTRA_MUX = (7);   //DPWM2C
  //RESON_MODE_FIXED_DUTY_EN = 0; default 0

  //-----------AUTOMID
  Dpwm0Regs.DPWMAUTOMID.bit.CLA_EN = 1;
  Dpwm0Regs.DPWMAUTOMID.bit.PWM_MODE = (1);
  Dpwm0Regs.DPWMAUTOMID.bit.PWM_A_INTRA_MUX = (0);
  Dpwm0Regs.DPWMAUTOMID.bit.PWM_B_INTRA_MUX = (0);

  //-----------AUTOMAX
  Dpwm0Regs.DPWMAUTOMAX.bit.CLA_EN = 1;
  Dpwm0Regs.DPWMAUTOMAX.bit.PWM_MODE = (1);
  Dpwm0Regs.DPWMAUTOMAX.bit.PWM_A_INTRA_MUX = (0);
  Dpwm0Regs.DPWMAUTOMAX.bit.PWM_B_INTRA_MUX = (0);
...
void init_dpwm1(void)
{
  ...
  Dpwm1Regs.DPWMCTRL0.bit.PWM_A_INTRA_MUX = (0);
  Dpwm1Regs.DPWMCTRL0.bit.PWM_B_INTRA_MUX = (0);

  //-----------AUTOMID
  Dpwm1Regs.DPWMAUTOMID.bit.CLA_EN = 1;
  Dpwm1Regs.DPWMAUTOMID.bit.PWM_MODE = (1);
  Dpwm1Regs.DPWMAUTOMID.bit.PWM_A_INTRA_MUX = (0);
  Dpwm1Regs.DPWMAUTOMID.bit.PWM_B_INTRA_MUX = (0);

  //-----------AUTOMAX
  Dpwm1Regs.DPWMAUTOMAX.bit.CLA_EN = 1;
  Dpwm1Regs.DPWMAUTOMAX.bit.PWM_MODE = (1);
  Dpwm1Regs.DPWMAUTOMAX.bit.PWM_A_INTRA_MUX = (0);
  Dpwm1Regs.DPWMAUTOMAX.bit.PWM_B_INTRA_MUX  = (0);
...
void init_dpwm2(void)
{
  ...
  //RESON_MODE_FIXED_DUTY_EN = 0;default 0 谐振模式固定占空比使能-0

  Dpwm2Regs.DPWMCTRL0.bit.CLA_EN = 1;
  Dpwm2Regs.DPWMCTRL0.bit.PWM_MODE = (0);
  Dpwm2Regs.DPWMCTRL0.bit.PWM_A_INTRA_MUX = (1);   
  Dpwm2Regs.DPWMCTRL0.bit.PWM_B_INTRA_MUX = (1);

  //-----------AUTOMID
  Dpwm2Regs.DPWMAUTOMID.bit.CLA_EN = 1;
  Dpwm2Regs.DPWMAUTOMID.bit.PWM_MODE = (1);
  Dpwm2Regs.DPWMAUTOMID.bit.PWM_A_INTRA_MUX = (4);
  Dpwm2Regs.DPWMAUTOMID.bit.PWM_B_INTRA_MUX = (5);
  //-----------AUTOMAX
  Dpwm2Regs.DPWMAUTOMAX.bit.CLA_EN = 1;
  Dpwm2Regs.DPWMAUTOMAX.bit.PWM_MODE = (1);
  Dpwm2Regs.DPWMAUTOMAX.bit.PWM_A_INTRA_MUX = (4);
  Dpwm2Regs.DPWMAUTOMAX.bit.PWM_B_INTRA_MUX = (5);

  //禁用高分辨率(default:0，Enable)
  Dpwm2Regs.DPWMCTRL1.bit.HIRES_DIS = 1;
  //覆盖无效配置的检查，并关闭PWM数学检查功能(default:1)
  ...
  Dpwm2Regs.DPWMPHASETRIG.all =  (((int)((1 / (1000e3)) / (250e-12) / 16 + 0.5)) * 8 + 32);  
  // Connect to dpwm2
...
void init_dpwm3(void)
{
  ...
  Dpwm3Regs.DPWMAUTOMID.bit.PWM_MODE = (1);
  Dpwm3Regs.DPWMAUTOMID.bit.PWM_A_INTRA_MUX = (0);
  Dpwm3Regs.DPWMAUTOMID.bit.PWM_B_INTRA_MUX = (0);

  //-----------AUTOMAX
  Dpwm3Regs.DPWMAUTOMAX.bit.CLA_EN = 1;
  Dpwm3Regs.DPWMAUTOMAX.bit.PWM_MODE = (1);
  Dpwm3Regs.DPWMAUTOMAX.bit.PWM_A_INTRA_MUX = (0);
  Dpwm3Regs.DPWMAUTOMAX.bit.PWM_B_INTRA_MUX = (0);
...
//全局周期是否使用，最小占空比是否使用，与谐振固定占空比的区别
//当修改频率时，min_period被修改，此时regulation_state，无影响。
//一旦出现错误，跳转transition_to_idle_state，重新调用configure_dpwm_timing
//此时min_period为修改后的，此时配置冲突-为何频率变化无法重启，参考LLC
void configure_dpwm_timing(PMBUS_DCDC_CONFIG *dpwm_timings)
{
...
//好像没使用？
  ...
  //Used for DPWMC, not enable blank_b
  ...
  Filter0Regs.FILTERYNCLPHI.all = ((int32)((dpwm_timings->min_period  << 4)* (418) * 1026)) >> 10;
