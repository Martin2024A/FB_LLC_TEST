...
/*-----------------------------------macro------------------------------------*/
const Uint8 setup_id[]          = "VERSION1|LLC001";
const Uint8 mfr_model[]			= "UCD3138ALLCEVM150";
const Uint8 mfr_revision[]		= "E3";
const Uint8 mfr_date[]			= "YYMMDD";
const Uint8 mfr_location[]		= "Dallas, TX";
const Uint8 mfr_serial[]		= "XXXXX";
const Uint8 mfr_ic_device[]		= "UCD3138RGC";
const Uint8 mfr_ic_device_rev[]	= "0";
const Uint8 mfr_id[]			= "TI";

#pragma DATA_SECTION (device_id_string, "FixedDeviceID");
const Uint8  device_id_string[] = "UCD3100ISO1|0.0.11.0106|141031";
...
void init_pmbus(int32 pmbus_address)
{
	...
	PMBusRegs.PMBCTRL2.all = 0x8000
							 + pmbus_address
							 + 0x7f00
							 + (0x00600000);
	pmbus_state = 0;  //initialize state to no message in progress
}
...
inline Uint8 pmbus_read_device_id(void)
{
	...
	string_len = (((sizeof("UCD3100ISO1|0.0.11.0106|141031"))>((32))) ? ((32)):(sizeof("UCD3100ISO1|0.0.11.0106|141031")));
...
inline Uint8 pmbus_read_mfr_id(void)
{
	send_string(mfr_id, (Uint8) sizeof("TI"));
	return 0;
}
Uint8 pmbus_read_write_mfr_id(Uint8 pmbus_read)
{
...
inline Uint8 pmbus_read_setup_id(void)
{
	send_string(setup_id, (Uint8) sizeof("VERSION1|LLC001"));
	return 0;
}
Uint8 pmbus_read_write_mfr_setup_id(Uint8 pmbus_read)
{
...
inline Uint8 pmbus_read_mfr_model(void)
{
	send_string(mfr_model, (Uint8) sizeof("UCD3138ALLCEVM150"));
	return 0;
}
Uint8 pmbus_read_write_mfr_model(Uint8 pmbus_read)
{
...
inline Uint8 pmbus_read_mfr_revision(void)
{
	send_string(mfr_revision, (Uint8) sizeof("E3"));
	return 0;
}
Uint8 pmbus_read_write_mfr_revision(Uint8 pmbus_read)
{
...
inline Uint8 pmbus_read_mfr_date(void)
{
	send_string(mfr_date, (Uint8) sizeof("YYMMDD"));
	return 0;
}
Uint8 pmbus_read_write_mfr_date(Uint8 pmbus_read)
{
...
inline Uint8 pmbus_read_mfr_location(void)
{
	send_string(mfr_location, (Uint8) sizeof("Dallas, TX"));
	return 0;
}
Uint8 pmbus_read_write_mfr_location(Uint8 pmbus_read)
{
...
inline Uint8 pmbus_read_mfr_serial(void)
{
	send_string(mfr_serial, (Uint8) sizeof("XXXXX"));
	return 0;
}
Uint8 pmbus_read_write_mfr_serial(Uint8 pmbus_read)
{
...
inline Uint8 pmbus_read_mfr_ic_device(void)
{
	send_string(mfr_ic_device, (Uint8) sizeof("UCD3138RGC"));
	return 0;
}
Uint8 pmbus_read_write_mfr_ic_device(Uint8 pmbus_read)
{
...
Uint8 pmbus_read_write_mfr_ic_device_rev(Uint8 pmbus_read)
{
	if(pmbus_read)
	{
		send_string(mfr_ic_device_rev, (Uint8) sizeof("0"));
		return 0;
	}
	else
		return pmbus_invalid_write();
...
/*------------------------------------test------------------------------------*/
const Uint32	parm_mem_start[19] = {	0x00019000,
									0xFFF7d100,
									0x00018800,
									0x00000000,
									0x00000000,
...
const Uint16	parm_mem_length[19] = {	(0x00019FFF - 0x00019000 + 1),
									(0xFFF7fdff - 0xFFF7d100 + 1),
									(0x00018FFF - 0x00018800 + 1),
									(0x00007FFF - 0x00000000 + 1),
									(0x00007FFF - 0x00000000 + 1),
									0x00000090,
									0x00000080,
									0x00000098,
...
const Uint8 debug_0_text[] = "Debug 0";
const Uint8 debug_1_text[] = "Debug 1";
const Uint8 debug_2_text[] = "Debug 2";
const Uint8 debug_3_text[] = "Debug 3";
const Uint8 debug_4_text[] = "Debug 4";
const Uint8 debug_5_text[] = "Debug 5";
const Uint8 debug_6_text[] = "Debug 6";
const Uint8 debug_7_text[] = "Debug 7";
const Uint8 na_text[] = "N/A";

const Uint8 yes_text[] = "Yes";
...
void send_string(const Uint8 string_to_send[], Uint8 num_bytes)
{
	...
	string_len = (Uint8) (((num_bytes)>(50 - 1)) ? (50 - 1):(num_bytes));
...
inline Uint8 pmbus_write_parm_info(void)
{
	...
	// They will be flagged in pmbus_write_parm_value() if a write to them is attempted.
  	if(temp_index > 19)  // Unsigned.
		{
			return (1<<(6));	// Error: Invalid Index
		}

		// Verify that the message is short enough to fit
	if(temp_length > 32)
		{
			return (1<<(6));	// Error: Length greater than SAA capabilities.
		}

		// Verify that the size is 1, 2, or 4 bytes
	if ((temp_size != 1) && (temp_size != 2) && (temp_size != 4))
		{
			return (1<<(6));	// Error: Invalid size
		}
...
inline Uint8 pmbus_write_parm_value(void)
{
	...
	// ----- VALIDATE DATA -----
		...
		{
			return (1<<(6));	// Error: Starting or ending addr out of range
		}
